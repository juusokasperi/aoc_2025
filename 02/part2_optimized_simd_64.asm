...
.scan_candidates:
	...
	vmovdqu ymm0, [r10]			; chunk a (bytes 0-31)
	vmovdqu ymm3, [r10 + 32]	; chunk b (byres 32-63)
	...
	vpcmpgtb ymm2, ymm0, ymm1 	; mask A 
	vpcmpgtb ymm4, ymm3, ymm1 	; mask B 
	...
	; if match found, check which chunk 
	vpmovmskb eax, ymm2 
	test eax, eax 
	jnz .found_in_chunk_a

	vpmovmskb eax, ymm4 
	tzcnt eax, eax 
	add r10, 32 
	jmp .handle_match_offset 
